...
f1 = open('../All/direct_six/train/seq.in','w')
f2 = open('../All/direct_six/test/seq.in','w')
f3 = open('../All/direct_six/valid/seq.in','w')
f4 = open('../All/direct_six/train/talker','w')
f5 = open('../All/direct_six/train/seq.out','w')
f6 = open('../All/direct_six/test/seq.out','w')
f7 = open('../All/direct_six/valid/seq.out','w')
f8 = open('../All/direct_six/test/talker','w')
f9 = open('../All/direct_six/train/intent','w')
f10 = open('../All/direct_six/test/intent','w')
f11 = open('../All/direct_six/valid/intent','w')
f12 = open('../All/direct_six/valid/talker','w')
f13 = open('../All/direct_six/train/info','w')
f14 = open('../All/direct_six/test/info','w')
f15 = open('../All/direct_six/valid/info','w')
